...
class LimitedLifetimeCouponConstraint extends CouponConstraint
{
    private $from;
    private $until;

    public function __construct(Coupon $coupon, \DateTimeInterface $from, \DateTimeInterface $until)
    {
